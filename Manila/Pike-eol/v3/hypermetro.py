...
class HyperPairManager(object):
    ...
    def create_remote_filesystem(self, params):
        fs_id = self.helper._create_filesystem(params)
        huawei_utils.wait_fs_online(
            self.helper, fs_id, constants.DEFAULT_WAIT_INTERVAL,
    ...
    def update_filesystem(self, fs_id, params):
        self.helper._change_share_size(fs_id, params)
    ...
    def get_remote_fs_info(self, share_name):
        self.helper._get_fs_info_by_name(share_name)
